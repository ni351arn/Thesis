...
Das Muster Risikobasiertes Schwachstellen- und Compliance-Management wird in der Literatur häufig unter dem Begriff "DevSecOps oder SecurityOps" beschrieben und umfasst KI-gestützte Mechanismen, um Sicherheitsereignisse im Plattformbetrieb frühzeitig zu erkennen und Reaktionsmaßnahmen zu priorisieren.
...
Als methodische Grundlage werden in der Literatur sowohl Deep-Learning-Ansätze (z.B.\ CNNs) als auch Gradient-Boosting-Verfahren (z.B.\ XGBoost) diskutiert, wobei letzteres insbesondere bei unausgewogenen Sicherheitsdaten robuste Ergebnisse liefern kann \cite{govindarajanMachineLearningBased2025, uddohAIBasedThreatDetection2021}.
