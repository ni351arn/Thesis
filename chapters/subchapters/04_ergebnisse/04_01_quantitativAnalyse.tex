...
Dabei wurde unterschieden, ob die jeweilige Form explizit, implizit genannt oder explizit erwähnt wird ohne tiefer einzugehen.
...
Die Auswertung zeigt, dass Supervised Learning in den meisten Arbeiten eine zentrale Rolle spielt. Es wird es in sechs Publikationen ausdrücklich beschrieben, in  elf Arbeiten erkennbar und in zwei kurz erwähnt. 
Reinforcement Learning wird insgesamt sieben mal explizit genannt und in vier weiteren Arbeiten erwähnt. 
Unsupervised Learning tritt mit drei expliziten und acht impliziten Nennungen seltener auf, ist jedoch ebenfalls präsent.


Die Verteilung ist in der folgenden Abbildung \ref{subsec:lernparadigmen} dargestellt.
\begin{figure}[H]
    \centering
