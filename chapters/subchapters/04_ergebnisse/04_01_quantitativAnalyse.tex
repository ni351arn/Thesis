...
Dazu wurden die ausgewählten Bereiche in fünf Kategorien unterteilt: Optimierung von CI/CD-Pipelines, Ressourcen- und Workload-Optimierung, Sicherheits- und Bedrohungserkennung, Resilienz, Self-Healing und Predictive Maintenance sowie Intelligente Bereitstellung (Edge-AI und Serverless Deployment).

Die Auswertung zeigt, dass CI/CD-Automatisierung mit acht Publikationen am häufigsten als primärer Anwendungsbereich beschrieben wird. 
An zweiter Stelle folgt die Ressourcen- und Workload-Optimierung, die in vier Studien als primärer Anwendungsbereich genannt wird.
...
Der vierte Bereich, Resilienz, Self-Healing und Predictive Maintenance wird insgesamt dreimal als Hauptanwendungsbereich definiert.
...
Die analysierten Paper wurden fünf Kategorien zugeordnet. Die Auswertung zeigt, dass 95 \% (20/21) der Studien Herausforderungen im Bereich Ressourcenverbrauch und Kosten nennen. 
Ebenfalls häufig angesprochen werden Skalierbarkeit, Latenz und Monitoring mit 90 \% (19/21). 
AI Governance, Datenschutz und Compliance findet sich in 81 \% (17/21) der Arbeiten wieder, ebenso wie die Kategorie Integrationskomplexität  und Abhängigkeiten.
Die fünfte Kategorie, Datenqualität, Datenverfügbarkeit und Heterogenität, wird in insgesamt 71 \% (15/21) der Arbeiten als Herausforderung thematisiert.  
...
Viele der Herausforderungen treten zudem gleichzeitig auf, da beispielsweise Skalierungsprobleme oft in engem Zusammenhang mit Ressourcenkosten oder Datenqualität stehen. 
...
Es wird in sechs Publikationen ausdrücklich beschrieben, in  elf Arbeiten erkennbar und in zwei kurz erwähnt. 
...
Die Ergebnisse zeigen ein deutliches Übergewicht von Deep-Learning-Verfahren, die in insgesamt 86 \% (18/21) der Publikationen eingesetzt oder thematisiert werden. 
Klassische Klassifikations- und Regressionsmethoden treten mit 52 \% (11/21) ebenfalls häufig auf. 
Demgegenüber werden Clustering-Verfahren und Ensemble- bzw. baumbasierte Modelle in 33 \% (7/21) der Arbeiten angesprochen.
...
\end{figure}
\par\bigskip
Die Ergebnisse aus Abschnitt 4.1 zeigen die zentralen Schwerpunkte der betrachteten Studien.
Darauf aufbauend wird in Abschnitt 4.2 untersucht, welche Kombinationen zwischen den Kategorien besonders häufig gemeinsam auftreten.
Dadurch werden typische Muster innerhalb der Literatur deutlicher sichtbar.