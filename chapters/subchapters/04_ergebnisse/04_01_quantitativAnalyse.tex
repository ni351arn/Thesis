...
Optimierung von \gls{ci}/\gls{cd}-Pipelines, Ressourcen- und Workload-Optimierung, Sicherheits- und Bedrohungserkennung sowie Betrieb und Orchestrierung der Plattform (GenOps).
...
Die Analyse zeigt, dass im Kontext des Platform Engineerings eine Vielfalt an \gls{ki}- und Verfahren des maschinellen Lernens (ML) eingesetzt wird.
