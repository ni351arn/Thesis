...
Ein weiterer Bestandteil der quantiativen Analyse umfasst die in den Publikationen verwendeten Formen des maschinellen Lernens. 
Dabei wurde unterschieden, ob die jeweilige Form explizit oder implizit erkennbar war in den Publikationen.
Insgesamt wurden die drei grundlegenden Formen identifziert: Supervised Learning, Unsupervised Learning und Reinforcement Learning, welche im Grundlagenkapitel genauer definiert und beschrieben wurden.

Die Auswertung zeigt, dass Supervised Learning in den meisten Arbeiten eine zentrale Rolle spielt. Zwar wird es nur in sechs Publikationen explizit thematisiert, jedoch in weiteren vierzehn Arbeiten implizit erkennbar. 
Unsupervised Learning tritt mit 4 expliziten und 5 impliziten Nennungen seltener auf, ist jedoch ebenfalls präsent. 
Reinforcement Learning wird ausschließlich explizit genannt und kommt in zehn Publikationen vor. 
...
Auffällig ist die deutliche Differenz zwischen explizit und implizit erkennbaren Anwendungen, insbesondere beim Supervised Learning. Dies zeigt, dass viele Publikationen entsprechende Verfahren nutzen, ohne die zugrunde liegende Formn ausdrücklich zu benennen.
