...
Die Abbildung \ref{fig:04_02_02_mappingZwei} visualisiert die Korrelation zwischen den in den analysierten Studien verwendeten Lernparadigmen von \gls{ml} und den eingesetzten Algorithmen.
...
Es wird am häufigsten mit \gls{dl} / \gls{nn} kombiniert ($n=14$), gefolgt von Klassifikation / Regression ($n=8$) sowie Ensemble- und baumbasierten Verfahren ($n=7$).
