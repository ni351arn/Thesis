...
Die Forschungsfragen werden durch ein strukturiertes methodisches Vorgehen beantwortet. Jede Forschungsphase ist darauf ausgelegt, das Verständnis über den Einsatz von KI im Platform Engineering schrittweise zu vertiefen.
Die Mapping-Studie dient der Beantwortung der ersten beiden Forschungsfragen, indem sie eine systematische Übersicht über bestehende KI-Ansätze und deren Anwendungsfelder liefert. 
Auf Grundlage der Ergebnisse der Mapping-Studie zielt die dritte Forschungsfrage darauf ab, ein praxisorientiertes Framework zur Beantwortung und Übertragbarkeit von KI-Lösungen zu entwickeln. 
...
\begin{description}[labelwidth=3em,labelsep=1em,leftmargin=!,font=\bfseries,itemsep=1em]
  \item[RQ1:] Welche typischen Anwendungsfelder (Use Cases) und Herausforderungen bestehen im Platform Engineering, in denen KI-Technologien potenziell Mehrwert bieten können?
