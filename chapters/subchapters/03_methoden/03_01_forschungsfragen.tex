...
\begin{description}[labelwidth=3em,labelsep=1em,leftmargin=!,font=\bfseries,itemsep=1em]
  ...
  \item[RQ3:] Wie lassen sich die identifizierten \gls{ki}-Lösungen auf typische Anwendungsfälle in Cloud-Native-Platform-Umgebungen übertragen und hinsichtlich ihres Mehrwertes und ihrer Umsetzbarkeit bewerten?
  \\ Ziel: Entwicklung eines Bewertungsschemas, das die Passung zwischen \gls{ki}-Lösungen und spezifischen Platform-Use-Cases beschreibt und die praktische Umsetzbarkeit aufzeigt.
\end{description}
