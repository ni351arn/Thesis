...
GitOps-Repository und Runbooks werden über eine lokale KI (RAG) kontextbezogen aufbereitet und als Zustandskontext an K8sGPT übergeben.
Die Ausgabe ist auf erklärende Handlungshinweise beschränkt. 
Die lokale KI (RAG) ist dabei ausschließlich als unterstützender Baustein zu verstehen. 
