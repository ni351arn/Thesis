...
Die Ergebnisse der Literaturanalyse werden in \autoref{ch:literaturErgebnisse} dargestellt und zu einer konzeptionellen Zuordnung zusammengeführt.
\autoref{ch:anwendungLiteraturrecherche} überträgt diese Zuordnung auf die \gls{bmlp} und wendet sie auf identifizierte Problemfelder an.
