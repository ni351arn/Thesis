...
Zur Einordnung wird \gls{aiops} von \gls{mlops}\footnote{\gls{mlops} bezeichnet Ansätze und Praktiken zur Entwicklung, zum Training, zur Bereitstellung und zum Betrieb von Modellen des maschinellen Lernens und adressiert primär den Lebenszyklus von \gls{ki}-Modellen.} abgegrenzt.
...
Im Mittelpunkt steht \gls{aiops} als operative Unterstützung für Platform Engineers, nicht \gls{mlops} als Infrastruktur für datenwissenschaftliche Arbeitsabläufe.
