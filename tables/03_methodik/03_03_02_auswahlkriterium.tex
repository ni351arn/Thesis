\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{@{}lY@{}}
    ...
    AK4 & Arbeiten mit primärem Fokus auf \gls{mlops}, insbesondere auf Infrastruktur, Deployment und Lebenszyklusmanagement von ML-Modellen für Data-Science-Workflows, ohne direkten Bezug zur operativen Unterstützung von Platform Engineers (AI for Ops). \\
    \bottomrule
  \end{tabularx}
\end{table}