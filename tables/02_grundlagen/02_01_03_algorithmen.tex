\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{@{}lY@{}}
    ...
    Ensemble und baumbasierte Verfahren & Kombinieren mehrere Modelle zur Steigerung der Vorhersagegenauigkeit und verarbeiten große sowie semi-strukturierte Datensätze effizient. \\
    ...
    Clustering & Gruppieren Datenpunkte ohne Labels zu inhaltlich ähnlichen Clustern und unterstützen dadurch Mustererkennung und Anomalieerkennung. \\
    \bottomrule
  \end{tabularx}
\end{table}
