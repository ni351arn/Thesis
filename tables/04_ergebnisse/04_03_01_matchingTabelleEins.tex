...
\gls{dl} zur Zeitreihenprognose oder \gls{rl} zur dynamischen Lastverteilung in Echtzeit.
\\
...
Limitationen &
Hoher Rechenaufwand für das Modelltraining, Startverzögerungen bei initialer Bereitstellung (serverlos), benötigt ca.\ 2 Monate historische Daten \cite{poudelAIDrivenIntelligentAutoScaling2025a,amteCloudNativeAIChallenges2025}.
\\

Einsatzvoraussetzungen &
Mind.\ 2 Monate historische Zeitreihen-Telemetrie aus CloudWatch/Prometheus sowie automatisierter API-Schreibzugriff für Instanz- bzw.\ Skalierungsanpassungen \cite{poudelAIDrivenIntelligentAutoScaling2025a}.
\\
