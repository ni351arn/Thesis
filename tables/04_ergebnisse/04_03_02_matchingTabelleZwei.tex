...
\toprule
\textbf{Automatisierte \newline Release-Absicherung} & \textbf{Beschreibung} \\
\midrule
...
\gls{ul} (Autoencoder) zur Anomalieerkennung oder \gls{rl} (z. B. DQN) zur Optimierung des Rollback-Zeitpunkts \cite{tamanampudiAIEnhancedContinuousIntegration}.
\\
...
Referenzwerte für Normalbetrieb aus Telemetriedaten (Latenz, Fehlerraten) sowie automatisches Zurücksetzen auf eine stabile Vorgängerversion und Echtzeit-Erfassung von Auslieferungskennzahlen \cite{tamanampudiAIEnhancedContinuousIntegration,bajwaCLOUDNATIVEARCHITECTURESLARGESCALE2025}.
\\
